...
//KONEKSI DB
$sql = "SELECT * FROM tb_siswa WHERE id_user='$data_id'";
...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-info navbar-light" style="background-color: #FFFFFF;">
			<div class="container-fluid">
				...
				<ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
					<a href="#" class="nav-link user-menu"> <img src="dist/img/avatar4.png" class="user-image rounded-circle shadow" alt="User Image"> <?php
		...
		<?php include('siswa/controller/sidebar.php') ?>
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<!-- /. WEB DINAMIS DISINI ############################################################################### -->
				<?php include('siswa/controller/routes.php') ?>
			</section>
			<!-- /.content -->
		</div>
		<!-- /.content-wrapper -->
