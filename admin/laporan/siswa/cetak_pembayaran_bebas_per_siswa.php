...
WHERE id_tahun_ajaran='$id_tahun_ajaran' AND tipe_jenis_bayar_siswa='bebas'");
            ...
            while ($djb = $sqlJenisBayar->fetch_assoc()) {
                $sql = $koneksi->query("SELECT tb_jenis_bayar_siswa.nama_bayar_siswa, tb_siswa.nama_siswa, 
                            SUM(tb_tagihan_bebas_siswa.total_tagihan) as totaljmlbayar2, 
                            SUM(tb_tagihan_bebas_siswa.terbayar) as totalterbayar 
                            ...
                            WHERE tb_tagihan_bebas_siswa.id_jenis_bayar_siswa='$djb[id_jenis_bayar_siswa]' 
                            AND tb_tagihan_bebas_siswa.id_siswa='$id_siswa' 
