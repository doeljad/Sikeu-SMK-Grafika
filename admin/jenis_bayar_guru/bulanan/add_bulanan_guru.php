...
?>
	...
	<script>
		function updateSelectedGuru() {
			var selectedGuru = document.getElementById('id_guru').value;
			var allGurus = document.querySelectorAll('.uang');
			allGurus.forEach(function(input) {
				if (input.name !== selectedGuru) {
					input.value = '';
				}
			});
		}
				...
				<div class="col-sm-6">
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-sm-6">
								<select class="form-control" name="id_guru" id="id_guru" required onchange="updateSelectedGuru()">
	...
	<div class="card card-warning">
		<div class="card-header">
			<h3 class="card-title">
				<i class="fa fa-table"></i> Data Tagihan Guru
			</h3>
		</div>
		<!-- /.card-header -->
		<div class="card-body">
		...
		?>
			<tr>
				...
				<td>
					<a href="?page=hapus-bulanan-guru&id_guru=<?php echo $data['id_guru']; ?>&id_jenis_bayar_guru=<?php echo $id_jenis_bayar_guru ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
						<i class="fa fa-trash"></i>
						<a />
						<a href="?page=edit-bulanan-guru&kode=<?php echo $data['id_guru']; ?>" title="Ubah" class="btn btn-success btn-sm">
